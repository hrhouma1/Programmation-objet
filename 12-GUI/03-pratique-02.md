...
Allez à ce lien et lire la documentation :

- https://github.com/hrhouma1/demo2-tkinter/blob/main/01_labels/01-cours-01.md

Faire le quiz 

- https://github.com/hrhouma1/demo2-tkinter/blob/main/01_labels/02-quiz.md

Regardez la correction:

 - https://github.com/hrhouma1/demo2-tkinter/blob/main/01_labels/03-correction.md
...
Très bien, je vois que tu veux **continuer l'organisation de ton document pédagogique**, dans la même logique claire que ce que tu as commencé.

Je vais donc prolonger **proprement** ton plan pour inclure **la suite des codes (2 à 10)**, **les liens vers les contenus à lire**, et **les tâches correspondantes** pour **chacun**.  
Je vais respecter ton style : sans emojis, professionnel, format structuré et progressif.

---

# 2 – Manipulations (Suite)
